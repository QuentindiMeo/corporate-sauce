 ...
 */
export function groupByTheme<TImage extends PostImage>(posts: readonly Post<TImage>[]): ThemeRow<TImage>[] {
 ...
 */
export function groupByMonth<TImage extends PostImage>(posts: readonly Post<TImage>[]): MonthRow<TImage>[] {
